import { TextField, Button, Box, duration } from "@mui/material";
...
export default function FullscreenPreview() {
  ...
  return (
    ...
    export default function PreviewPanel(props: {
      ...
      const [exportCanvasRef, setExportCanvasRef] = useState(null);
      ...
      const exportVideo = () => {
        ...
        console.log(exportCanvasRef);
    
        const cexportCanvasRef = exportCanvasRef as HTMLCanvasElement
    
        const stream = cexportCanvasRef.captureStream(30) as MediaStream;
        const mediaRecorder = new MediaRecorder(stream, { mimeType: "video/webm" });
        const chunks: BlobPart[] = [];
            ...
            >
              {props.vidData ? (
                <>
                  ...
                  <Canvas
                    id="exportCanvas"
                    ref={(ref) => setExportCanvasRef(ref)}
                    style={{
                      position: "absolute",
                      top: 0,
                      left: 0,
